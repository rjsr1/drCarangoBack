...
public class ComentarioRepository {
    ...
    public static void initComentarios(){
        if(comentarios!=null){
            ...
            Comentario c3=new Comentario(3,"joao","boa opção",3.0,1);
            Comentario c4=new Comentario(4,"rodolfo","boa opção",4.0,1);
            Comentario c5=new Comentario(5,"jose","boa opção",3.0,1);
            Comentario c6=new Comentario(6,"maria","boa opção",5.0,1);
            Comentario c7=new Comentario(7,"carlos","boa opção",4.0,1);
            Comentario c8=new Comentario(8,"antonio","boa opção",5.0,2);
            Comentario c9=new Comentario(9,"claudio","boa opção",3.0,2);
            Comentario c10=new Comentario(10,"kibe","boa opção",3.0,2);
            Comentario c11=new Comentario(11,"marcos","boa opção",2.0,2);
            Comentario c12=new Comentario(12,"rodolfo","boa opção",3.0,2);
            ...
            Comentario c17=new Comentario(17,"rodolfo","boa opção",3.0,4);
            Comentario c18=new Comentario(18,"rodolfo","boa opção",4.0,4);
            Comentario c19=new Comentario(19,"rodolfo","boa opção",2.0,4);
            Comentario c20=new Comentario(20,"rodolfo","boa opção",1.0,3);
            comentarios.add(c1);
            comentarios.add(c2);
            comentarios.add(c3);
            comentarios.add(c4);
